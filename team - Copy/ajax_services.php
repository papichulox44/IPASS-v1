<?php 
  ...
  //       <input style="width: 200px; float: right" id="myInput'.$j.'" type="text" class="form-control" placeholder="Search.."><br>
		// <table class="table table-striped table-hover table-bordered table-vcenter '.$md_body.'">
  //                   <thead>
  //                       <tr>
...
//_______________________________ END FILTER
    ...
    echo '
        <script>
            ...
            document.getElementById("total_task'.$j.'").innerHTML = parseInt(temp_total) + '.$total_task .';
